...
public class SmsMessagingDemo extends Activity {
    ...
    public static final String SMS_RECIPIENT_EXTRA = "afirsraftgarrier.demoandroid.androidapi.os.SMS_RECIPIENT";

    public static final String ACTION_SMS_SENT = "afirsraftgarrier.demoandroid.androidapi.os.SMS_SENT_ACTION";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ComponentName componentName = new ComponentName("afirsraftgarrier.demoandroid.androidapi",
                "afirsraftgarrier.demoandroid.androidapi.os.SmsMessageReceiver");
