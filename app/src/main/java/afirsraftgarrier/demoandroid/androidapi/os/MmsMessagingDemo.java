...
package afirsraftgarrier.demoandroid.androidapi.os;
// Because the mms package problem, i common out the code.
...
public class MmsMessagingDemo extends Activity {
    ...
    private static final String ACTION_MMS_SENT = "afirsraftgarrier.demoandroid.androidapi.os.MMS_SENT_ACTION";
    private static final String ACTION_MMS_RECEIVED =
            "afirsraftgarrier.demoandroid.androidapi.os.MMS_RECEIVED_ACTION";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final ComponentName componentName = new ComponentName("afirsraftgarrier.demoandroid.androidapi",
                "afirsraftgarrier.demoandroid.androidapi.os.MmsWapPushReceiver");
    ...
    //                       .authority("afirsraftgarrier.demoandroid.androidapi.os.MmsFileProvider")
    //                       .path(fileName)
