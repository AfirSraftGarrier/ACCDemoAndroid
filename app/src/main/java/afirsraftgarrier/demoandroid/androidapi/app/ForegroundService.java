...
public class ForegroundService extends Service {
    static final String ACTION_FOREGROUND = "afirsraftgarrier.demoandroid.androidapi.FOREGROUND";
    static final String ACTION_FOREGROUND_WAKELOCK = "afirsraftgarrier.demoandroid.androidapi.FOREGROUND_WAKELOCK";
    static final String ACTION_BACKGROUND = "afirsraftgarrier.demoandroid.androidapi.BACKGROUND";
    static final String ACTION_BACKGROUND_WAKELOCK = "afirsraftgarrier.demoandroid.androidapi.BACKGROUND_WAKELOCK";
