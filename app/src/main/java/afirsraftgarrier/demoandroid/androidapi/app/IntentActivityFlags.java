...
//BEGIN_INCLUDE(intent_array)
    private Intent[] buildIntentsToViewsLists() {
        ...
        intent.setClass(IntentActivityFlags.this, afirsraftgarrier.demoandroid.androidapi.ApiDemos.class);
        intent.putExtra("afirsraftgarrier.demoandroid.androidapi.Path", "Views");
        intents[1] = intent;

        intent = new Intent(Intent.ACTION_MAIN);
        intent.setClass(IntentActivityFlags.this, afirsraftgarrier.demoandroid.androidapi.ApiDemos.class);
        intent.putExtra("afirsraftgarrier.demoandroid.androidapi.Path", "Views/Lists");
