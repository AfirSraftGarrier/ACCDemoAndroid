...
<table class="LinkTable">
        <tr>
            <td class="LinkColumn">src/afirsraftgarrier.demoandroid.androidapi/app/ReceiveResult.java</td>
            <td class="DescrColumn">Launches pick activity and receives its result</td>
        </tr>
        <tr>
            <td class="LinkColumn">src/afirsraftgarrier.demoandroid.androidapi/app/SendResult.java</td>
