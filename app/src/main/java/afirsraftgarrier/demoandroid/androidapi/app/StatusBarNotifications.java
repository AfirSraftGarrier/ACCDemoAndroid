...
//BEGIN_INCLUDE(intent_array)
    private PendingIntent makeDefaultIntent() {
        ...
        // "App"
        intents[1] = new Intent(this, afirsraftgarrier.demoandroid.androidapi.ApiDemos.class);
        intents[1].putExtra("afirsraftgarrier.demoandroid.androidapi.Path", "App");
        // "App/Notification"
        intents[2] = new Intent(this, afirsraftgarrier.demoandroid.androidapi.ApiDemos.class);
