...
//BEGIN_INCLUDE(intent_array)
    ...
    static Intent[] makeMessageIntentStack(Context context, CharSequence from,
        ...
        intents[0] = Intent.makeRestartActivityTask(new ComponentName(context,
                afirsraftgarrier.demoandroid.androidapi.ApiDemos.class));

        // "App"
        intents[1] = new Intent(context, afirsraftgarrier.demoandroid.androidapi.ApiDemos.class);
        intents[1].putExtra("afirsraftgarrier.demoandroid.androidapi.Path", "App");
        // "App/Notification"
        intents[2] = new Intent(context, afirsraftgarrier.demoandroid.androidapi.ApiDemos.class);
        intents[2].putExtra("afirsraftgarrier.demoandroid.androidapi.Path", "App/Notification");
